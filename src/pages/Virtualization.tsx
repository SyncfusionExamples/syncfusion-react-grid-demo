    ...
    steps: (
      <div className="space-y-2">
        ...
        <div className="bg-white rounded p-2 border-l-4 border-red-500">
          ...
          <p className="text-xs text-gray-600 mt-1 italic">To enable row virtualization for smooth scrolling with large datasets, set virtualizationSettings.type as VirtualDomType.Row.</p>
