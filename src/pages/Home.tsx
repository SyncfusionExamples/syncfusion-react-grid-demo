        ...
        <div className="bg-white rounded-2xl shadow-2xl p-12 mb-16 border border-blue-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="p-6 bg-gradient-to-br from-blue-50 to-gray-50 rounded-xl border border-blue-200 hover:border-blue-400 hover:shadow-lg hover:scale-105 transition-all duration-300">
